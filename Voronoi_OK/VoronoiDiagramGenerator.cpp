...
struct Halfedge * VoronoiDiagramGenerator::ELleftbnd(struct VoronoiPoint *p)
{
	int i, bucket;
	struct Halfedge *he;
...
struct Site * VoronoiDiagramGenerator::intersect(struct Halfedge *el1, struct Halfedge *el2, struct VoronoiPoint *p)
{
	struct	Edge *e1,*e2, *e;
	struct  Halfedge *el;
	float d, xint, yint;
...
int VoronoiDiagramGenerator::right_of(struct Halfedge *el,struct VoronoiPoint *p)
{
	struct Edge *e;
	struct Site *topsite;
...
struct VoronoiPoint VoronoiDiagramGenerator::PQ_min()
{
